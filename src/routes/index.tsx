...
const features: Feature[] = [
  { title: "Lagrangian", tag: "Dynamics", blurb: "A single line of mathematics that describes how every field in nature moves and interacts.", Viz: VizLagrangian, eq: "ℒ = ψ̄(iγᵘ∂ᵤ − m)ψ", url: "/lagrangian" },
  { title: "Feynman Diagram", tag: "Interactions", blurb: "Pictures of probability. Each line is a particle, each vertex a moment of exchange.", Viz: VizFeynman, url: "/feynman" },
  { title: "Path Integral", tag: "Sum over Histories", blurb: "A particle takes every possible path. Reality is the interference of them all.", Viz: VizPathIntegral, url: "/path-integral" },
  { title: "Renormalization", tag: "Scale", blurb: "Infinities tamed. The art of asking nature only the questions it can answer.", Viz: VizRenormalization, url: "/renormalization" },
  { title: "Vacuum", tag: "Zero-Point", blurb: "Empty space is not empty. It bubbles with energy that holds the cosmos together.", Viz: VizVacuum, url: "/vacuum" },
  { title: "Symmetries", tag: "Invariance", blurb: "Every conservation law is a hidden symmetry. The universe protects what it loves.", Viz: VizSymmetries, url: "/symmetries" },
];
      ...
      <main className="relative z-10 flex-1 min-w-0">
        ...
        <div className="hidden md:flex items-center justify-between gap-4 px-6 lg:px-10 py-5 border-b border-violet/10">
          <div className="text-[13px] leading-snug text-muted-foreground">
            <div className="text-foreground/80">You are exploring the language of the universe.</div>
        ...
        <div className="flex">
          <div className="flex-1 min-w-0 px-4 sm:px-6 lg:px-10 py-6 md:py-8 space-y-8 md:space-y-12">
            {/* HERO */}
            <section className="relative rounded-3xl overflow-hidden glass-strong h-[78vh] min-h-[520px] md:h-[640px]">
              <QuantumFieldHero />
              {/* Layered veils so text always reads */}
              <div className="absolute inset-0 bg-gradient-to-r from-background/85 via-background/40 to-background/10 pointer-events-none" />
              ...
              <div className="relative z-10 h-full flex flex-col justify-between p-6 sm:p-10 lg:p-14">
                <div className="max-w-2xl">
                  ...
                  <p className="mt-6 md:mt-8 text-base md:text-lg text-foreground/75 leading-relaxed max-w-xl font-light">
                    Beneath every particle, every photon, every atom — a continuous, invisible
                    ocean of fields fills all of space. What we call <em className="text-foreground/90 not-italic font-normal">matter</em> is
                    its ripples. What we call <em className="text-foreground/90 not-italic font-normal">force</em> is its exchange.
                  </p>
                  <p className="mt-3 font-display italic text-xl md:text-2xl text-violet text-glow-violet">
                    Move your cursor. Disturb the vacuum.
                  </p>
                ...
                <div className="hidden sm:flex items-center gap-2 text-[10px] tracking-[0.3em] uppercase text-muted-foreground/70">
                  ...
                  Hover over the field — the vacuum responds
                </div>
              </div>
            </section>

            {/* What is QFT — educational intro */}
            <section className="grid md:grid-cols-3 gap-4 md:gap-6">
              {[
                { n: "I", t: "Fields are fundamental.", b: "Forget particles as tiny balls. The deepest layer of reality is a smooth field stretched across all of space — one for electrons, one for photons, one for each species of matter." },
                { n: "II", t: "Particles are excitations.", b: "When a field vibrates, we see a particle. An electron is a knot of energy in the electron field. A photon is a ripple of light in the electromagnetic one. Same field, many particles." },
                { n: "III", t: "Interaction is exchange.", b: "Forces are not magic at a distance. They are fields whispering to one another — photons exchanged between charges, gluons binding quarks, fields shaping fields." },
              ].map((c, i) => (
                <article key={i} className="glass-deep rounded-2xl p-6 md:p-7 relative overflow-hidden group">
              ...
              <div className="relative grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground text-base mb-3 leading-relaxed font-light">
                    QFT explains almost everything we have measured — and almost nothing we cannot.
                    Dark matter, the weight of the vacuum, the quantum nature of gravity itself remain open questions.
                  </p>
